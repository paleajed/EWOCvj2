...
void Program::add_main_oscmethods() {
	...
	mainprogram->st->add_method("/mix/preview/wipe/xpos", "i", [](lo_arg **argv, int){mainmix->wipex[0] = argv[0]->i;});
	mainprogram->st->add_method("/mix/preview/wipe/ypos", "i", [](lo_arg **argv, int){mainmix->wipey[0] = argv[0]->i;});
