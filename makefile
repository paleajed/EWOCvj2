...
$(BIN)/start.exe: $(OBJ)/loopstation.o $(OBJ)/node.o $(OBJ)/mixer.o $(OBJ)/start.o 
	$(CC) $(LDFLAGS) -o $(BIN)/start.exe $(OBJ)/loopstation.o $(OBJ)/node.o $(OBJ)/mixer.o $(OBJ)/start.o $(LDLIBS) 
